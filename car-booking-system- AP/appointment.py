...
class Application:
    def __init__(self, master):
        ...
        self.right = Frame(master, width=600, height=720, bg='Blue')
        self.right.pack(side=RIGHT)

        # labels for the window
        self.heading = Label(self.left, text="Car Booking", font=(
            'georgia 40 bold'), fg='black', bg='blue')
        self.heading.place(x=170, y=0)
        # patients name
        self.name = Label(self.left, text="Booking Under Name", font=(
            'georgia 18 bold'), fg='black', bg='blue')
        ...
        # location
        self.location = Label(self.left, text="Pickup Location", font=(
            'georgia 18 bold'), fg='black', bg='blue')
        self.location.place(x=0, y=220)

        # appointment time
        self.time = Label(self.left, text="Time", font=(
            'georgia 18 bold'), fg='black', bg='blue')
        ...
        self.submit = Button(self.left, text="Add Booking", width=10,
                             height=1, bg='white', command=self.add_appointment)
        self.submit.place(x=350, y=340)
        ...
        self.logs = Label(self.right, text="Booking logs", font=(
            'georgia 28 bold'), fg='black', bg='blue')
        self.logs.place(x=100, y=10)

        self.box = Text(self.right, width=60, height=30)
